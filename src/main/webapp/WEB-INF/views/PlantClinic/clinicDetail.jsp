...
<!-- 			            </form> -->
	            ...
	            <c:if test="${loginInfo.user_num eq comment.user_num}">
				  <p>
				    <a href="${pageContext.request.contextPath}/Clinic/comment/update?plccom_idx=${comment.plccom_idx}&plc_idx=${clinic.plc_idx}">수정</a> |
				    <a href="${pageContext.request.contextPath}/Clinic/comment/delete?plccom_idx=${comment.plccom_idx}&plc_idx=${clinic.plc_idx}" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
				  </p>
				</c:if>
