...
<body>
	<form name="updateNoticeForm" id="updateNoticeForm" method="post" action="updateNoticeProcess" enctype="multipart/form-data">
		...
		<input type="hidden" name="original_img" value="${notice.n_img}">
			...
			<label for="n_contents">공지 내용 : </label><textarea name="n_contents" id="n_contents" rows="5" cols="50">${notice.n_contents}</textarea><br>
<%-- 			현재 이미지: <img src="${pageContext.request.contextPath}/img/store/${notice.n_img}" style="width:500px;"><br> --%>
