...
<body>
    ...
    <div class="container_12">	
	  ...
	  <div class="grid_8">	
		<h3>게시글 수정</h3>
			<form id="form" name="plantForm" method="post" action="${pageContext.request.contextPath}/Plant/plantUpdateProc" enctype="multipart/form-data"
			 onsubmit="return validateForm()">
			    ...
			    기존 이미지 : <img src="${pageContext.request.contextPath}/img/plant/${dto.pla_img}" width="100" /> <br>
