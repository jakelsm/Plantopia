    ...
    <table class="api-table">
      ...
      <c:forEach var="dto" items="${list}">
        <tr>
          ...
          <td class="actions">
            <a href="${pageContext.request.contextPath}/accountUpdate?user_num=${dto.user_num}"><button type="button" class="action-btn">수정</button></a>
            <a href="${pageContext.request.contextPath}/accountDelete?user_num=${dto.user_num}"><button type="button" class="action-btn">삭제</button></a>
          </td>
        </tr>
      </c:forEach>
    </table>
